...
export function ChatbotButton() {
  ...
  const [messages, setMessages] = useState<Message[]>([
      {
        role: 'bot',
        text: 'I am your GtaFans assistant. Ask me about GTA 6 trailers, speculation, locations, characters, or site navigation.',
      },
  ])
      ...
      {open ? (
        <div className="fixed bottom-24 right-6 z-50 flex h-[500px] w-[350px] max-w-[calc(100vw-24px)] flex-col overflow-hidden rounded-2xl border border-border bg-panel shadow-2xl backdrop-blur-md">
          <div className="flex items-center gap-3 border-b border-border bg-panel-2/50 px-4 py-3.5">
            ...
            <div>
              <p className="font-display text-sm font-bold text-text">FanBot</p>
              <p className="text-[10px] uppercase font-bold tracking-wider text-accent">GTA 6 helper</p>
            </div>
