...
export async function SiteShell({
  ...
  return (
    <main className="min-h-screen text-white selection:bg-fuchsia-500/30">
      ...
      <div className="relative mx-auto w-full max-w-[1440px] px-4 pb-12 pt-4 sm:px-6 lg:px-8">
        ...
        {title ? (
          <section className="relative mt-4 overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(10,8,24,0.96),rgba(10,12,38,0.98))] px-5 py-8 shadow-[0_24px_90px_rgba(0,0,0,0.22)] sm:px-8 sm:py-10">
