  ...
  return (
    <div className="rounded-xl border border-border bg-panel-2/5 p-4 mt-3">
      <div className="rounded-xl border border-border bg-panel p-5 shadow-sm">
        <p className="text-[10px] uppercase font-bold tracking-wider text-accent">GtaFans Mail</p>
    ...
    <GlassPanel>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-3">
        <div>
          ...
          <EmailPreview
            title="Welcome to GtaFans"
            description="Your account is active. Start tracking posts, saving categories, and following GTA 6 updates across the site."
          />
        </div>
        <div>
        ...
        <div>
          ...
          <EmailPreview
            ...
            description="Your contact request is now in the GtaFans support queue. A team member will follow up as soon as possible."
          />
        </div>
      </div>
    </GlassPanel>
